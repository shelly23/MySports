...
public class DBCommands {
    ...
    static final String SQL_CREATE_MOCKDATA7 =
            "INSERT INTO days VALUES ('5','2023-01-04','123','0','1','0');";
    static final String SQL_CREATE_MOCKDATA2 =
            "INSERT INTO days VALUES ('0','2023-01-03','122','0','1','0');";
    static final String SQL_CREATE_MOCKDATA3 =
            "INSERT INTO days VALUES ('1','2023-01-02','1235','0','1','0');";
    static final String SQL_CREATE_MOCKDATA4 =
            "INSERT INTO days VALUES ('2','2023-01-01','4245','1','0','0');";
    static final String SQL_CREATE_MOCKDATA5 =
            "INSERT INTO days VALUES ('3','2022-12-31','345','0','0','0');";
    static final String SQL_CREATE_MOCKDATA6 =
            "INSERT INTO days VALUES ('4','2022-12-30','2340','1','0','0');";

    static final String SQL_CREATE_ENTRIES_DAYS =
            "CREATE TABLE IF NOT EXISTS days (_id BIGINT AUTO_INCREMENT PRIMARY KEY,actual_date date,steps int,active bool,attack bool,user_id BIGINT,FOREIGN KEY(user_id) REFERENCES users(id))";
